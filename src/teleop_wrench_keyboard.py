...
# Import messages of type Wrench instead of Twist
...
class PublishThread(threading.Thread):
    def __init__(self, rate):
        ...
        # Publish Wrench messages to the '/rexrov/thruster_manager/input' topic
    ...
    def run(self):
        ...
        # Read the Wrench messages into a variable 'wrench'
        wrench = Wrench()
        while not self.done:
            self.condition.acquire()
